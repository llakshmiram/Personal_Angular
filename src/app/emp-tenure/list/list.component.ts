...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['sno', 'empId', 'empName', 'cadCode', 'cadName', 'cadCate', 'preOffCode','tranOffcCode', 'datOfTransOdr', 'action'];
  ...
  additionalRows: AdditionalRow[] = [
    { sno: 1, empId: '12345', empName: 'John Doe', cadCode: '12AS', cadName: 'Part', cadCate: 'pending', preOffCode: '12ASD', tranOffcCode: '123ABCD', datOfTransOdr: 'Sep30', action:'view'},
