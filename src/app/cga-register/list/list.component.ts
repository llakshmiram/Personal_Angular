...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['sno', 'regNo', 'appName', 'datOfApp', 'eligiStatus', 'appStatus', 'action'];
  ...
  additionalRows: AdditionalRows[] = [
    { sno: 1, regNo: '12345', appName: 'John Doe', datOfApp: '12AS', eligiStatus: 'Part', appStatus: '123', action:'view'},
