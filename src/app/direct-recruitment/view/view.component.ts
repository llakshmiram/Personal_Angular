...
export class ViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.personalForm = this.fb.group({
      ...
      prpSentGovOn: ['', Validators.required],
      bdsResRefe: ['', Validators.required],
      goObtain: ['', Validators.required],
      propSts: ['', Validators.required],
      propSentToTnpsc: ['', Validators.required],
      goRefe: ['', Validators.required],
      candSentToBord: ['', Validators.required],
      tnpscSts: ['', Validators.required],
      noOfPrsonsJoin: ['', Validators.required]
