...
export class View2Component implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.personalForm = this.fb.group({
        ...
        prtyDscrton: ['', Validators.required],
        prtyDstrict: ['', Validators.required],
        prtyDvson: ['', Validators.required],
        prtytalk: ['', Validators.required],
        prtyVilge: ['', Validators.required],
        srvyNum: ['', Validators.required],
        araOfPrty: ['', Validators.required],
        ntrOfLnd: ['', Validators.required],
        acqrdEmp: ['', Validators.required],
        byrNme: ['', Validators.required],
        byrReltonsp: ['', Validators.required],
        dtOfAcqtn: ['', Validators.required],
        mdOfAqston: ['', Validators.required],
        selrName: ['', Validators.required],
        vlueOfPrties: ['', Validators.required],
        sntonDetls: ['', Validators.required],
        analIncm: ['', Validators.required],
