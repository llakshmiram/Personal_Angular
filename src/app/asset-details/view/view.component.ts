...
export class ViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.personalForm = this.fb.group({
      ...
      srcOfIncm: ['', Validators.required],
      vluOfPrty: ['', Validators.required],
      prtyRejName: ['', Validators.required],
      doPurchse: ['', Validators.required],
      prtyDscrtn: ['', Validators.required],
      yrlyIncmPrty: ['', Validators.required],
      upldoc: ['', Validators.required],
