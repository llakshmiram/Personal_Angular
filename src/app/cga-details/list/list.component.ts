...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['sno', 'cadCode', 'cadName', 'cadCate', 'bdResNO', 'rdResDat', 'action'];
  ...
  additionalRows: AdditionalRows[] = [
    { sno: 1, cadCode: '12345', cadName: 'John Doe', cadCate: '12AS', bdResNO: 'Part', rdResDat: '123', action:'view'},
