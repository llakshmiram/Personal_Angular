...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['sno', 'empId', 'empName', 'cadCode', 'cadName', 'fileNo', 'fileSts', 'action'];
  ...
  additionalRows: AdditionalRows[] = [
    { sno: 1, empId: '12345', empName: 'John Doe', cadCode: '12AS', cadName: 'Part', fileNo: '123', fileSts: 'approved', action:'view'},
