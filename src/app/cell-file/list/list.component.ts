...
export class ListComponent implements OnInit {
  ...
  columnsToDisplay = ['sno', 'fileNum', 'natCaseNum', 'cadModChar', 'noOfPer', 'status', 'action'];
  ...
  additionalRows: AdditionalRows[] = [
    { sno: 1, fileNum: '12345', natCaseNum: 'John Doe', cadModChar: '12AS', noOfPer: 'Part', status: 'pending', action:'view'},
